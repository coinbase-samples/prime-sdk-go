...
type GetWalletBalancesResponse struct {
	...
	Request               *GetWalletBalancesRequest `json:"request"`
}

func (c Client) GetWalletBalances(
	ctx context.Context,
	request *GetWalletBalancesRequest,
) (*GetWalletBalancesResponse, error) {
	...
	response := &GetWalletBalancesResponse{Request: request}
