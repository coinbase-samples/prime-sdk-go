...
type GetOrderFillsRequest struct {
...
type GetOrderFillsResponse struct {
	...
	Request    *GetOrderFillsRequest `json:"request"`
}

func (c Client) GetOrderFills(
	ctx context.Context,
	request *GetOrderFillsRequest,
) (*GetOrderFillsResponse, error) {
	...
	response := &GetOrderFillsResponse{Request: request}
