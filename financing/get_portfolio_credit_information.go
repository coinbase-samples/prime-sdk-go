...
type GetPortfolioCreditInformationRequest struct {
...
func (s *financingServiceImpl) GetPortfolioCreditInformation(
...
) (*GetPortfolioCreditInformationResponse, error) {
	...
	response := &GetPortfolioCreditInformationResponse{Request: request}
